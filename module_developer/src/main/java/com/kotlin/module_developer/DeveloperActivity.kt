package com.kotlin.module_developer

import androidx.recyclerview.widget.DividerItemDecoration
import androidx.recyclerview.widget.LinearLayoutManager
import com.alibaba.android.arouter.facade.annotation.Route
import com.kotlin.lib_base.base.BaseActivity
import com.kotlin.lib_base.base.adapter.CommonAdapter
import com.kotlin.lib_base.base.adapter.CommonViewHolder
import com.kotlin.lib_base.helper.ARouterHelper
import com.kotlin.module_developer.data.DeveloperListData
...
class DeveloperActivity : BaseActivity() {
    ...
    override fun getTitleText(): String {
        return getString(com.kotlin.lib_base.R.string.app_title_developer)
    }
...
//            .start()
    ...
    private fun initData() {
        val dataArray = resources.getStringArray(com.kotlin.lib_base.R.array.DeveloperListArray)
        dataArray.forEach {
            //说明是标题
            if (it.contains("[")) {
            ...
            CommonAdapter(mList, object : CommonAdapter.OnMoreBindDataListener<DeveloperListData> {
                override fun onBindViewHolder(
                    ...
                    when (model.type) {
                        ...
                        mTypeContent -> {
                            viewHolder.setText(
                                R.id.mTvDeveloperContent, "${position}.${model.text}"
                            )
